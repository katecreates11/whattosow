...
export const alt = "What You Need for Your First Allotment — What To Sow";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <p style={{ fontSize: "24px", color: "#6B5D4F", margin: 0 }}>
            The tools that earn their shed space — honest picks, no fluff
          </p>
        </div>

        <span style={{ fontSize: "18px", color: "#8C7D6D" }}>
          whattosow.co.uk/guides/allotment-essentials
        </span>
      </div>
    ),
    { ...size }
