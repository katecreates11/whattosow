...
export const alt = "Composting for Allotments — What To Sow";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <p style={{ fontSize: "24px", color: "#6B5D4F", margin: 0 }}>
            Cold bins, hot bins, wormeries, and bokashi — which method suits you
          </p>
        </div>

        <span style={{ fontSize: "18px", color: "#8C7D6D" }}>
          whattosow.co.uk/guides/composting
        </span>
      </div>
    ),
    { ...size }
