    ...
    <aside className="my-8 border-y border-earth/10 py-5" aria-labelledby="frost-buyer-note">
      ...
      <div className="space-y-4 text-[15px] leading-relaxed">
        <p className="text-earth">
          <span className="font-mono text-[10px] uppercase tracking-[0.12em] text-earth">Buy fleece if</span>{" "}
          you grow tender plants, early potatoes or spring seedlings and need quick cover for surprise frosts.{" "}
          <span className="font-mono text-[10px] uppercase tracking-[0.12em] text-earth">Add a cloche if</span>{" "}
          you want one row of salad or seedlings to keep moving through a cold spell.{" "}
          <span className="font-mono text-[10px] uppercase tracking-[0.12em] text-earth">Skip if the forecast is mild</span>{" "}
          and you are only growing hardy winter crops.
        </p>
