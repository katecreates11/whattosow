...
export const alt = "Spring Vegetables to Plant in the UK — What To Sow";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <p style={{ fontSize: "24px", color: "#6B5D4F", margin: 0 }}>
            Every crop you can sow this spring, with exact timing
          </p>
        </div>

        <span style={{ fontSize: "18px", color: "#8C7D6D" }}>
          whattosow.co.uk/guides/spring-vegetables
        </span>
      </div>
    ),
    { ...size }
