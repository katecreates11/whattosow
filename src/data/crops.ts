...
export const crops: Crop[] = [
...
},
  {
    ...
    slug: "maincrop-potatoes",
    category: "hardy",
    sowIndoorsWeeks: null,
    directSowWeeks: -1,
    plantOutWeeks: null,
    harvestWeeks: 20,
    tip: "Plant a few weeks after earlies. Earth up as haulms grow. Harvest when foliage dies back — leave in the ground for a week first to toughen the skins.",
    needs: "Sun. Rich, deep soil. Water consistently once tubers are forming.",
    spacingCm: 38,
    unsplashId: "1756361947495-7f56ed41ac38",
    seedSuppliers: [
      { name: "Thompson & Morgan", url: "https://www.thompson-morgan.com/search?q=maincrop+potatoes+seeds" },
      { name: "Sarah Raven", url: "https://www.sarahraven.com/search?q=maincrop+potatoes+seeds" },
      { name: "Suttons", url: "https://www.suttons.co.uk/search?q=maincrop+potatoes+seeds" },
    ],
    varieties: [
      { name: "Desiree", note: "Red-skinned, reliable, great all-rounder" },
      { name: "King Edward", note: "The classic roaster and chipper" },
      { name: "Sarpo Mira", note: "Exceptional blight resistance — the sensible choice" },
    ],
    blightRisk: true,
    liftFromSoil: true,
},
  ...
  // === FRUIT ===
  {
    ...
    plantOutWeeks: -4,
    harvestWeeks: 12,
    tip: "Plant runners in spring or late summer and you will be picking fruit the following June. Net them or the birds will get there first. Replace plants every three years for the best yields.",
    needs: "Full sun. Rich, well-drained soil. Mulch with straw to keep fruit clean and stop rot. Water regularly when fruiting.",
    spacingCm: 35,
    companionPlants: ["Lettuce", "Spinach", "Borage"],
    avoidPlants: ["Cabbage", "Broccoli"],
    minSoilTempC: 5,
    seedSuppliers: [
      { name: "Thompson & Morgan", url: "https://www.thompson-morgan.com/search?q=strawberry+plants" },
      { name: "Sarah Raven", url: "https://www.sarahraven.com/search?q=strawberry+plants" },
      { name: "Suttons", url: "https://www.suttons.co.uk/search?q=strawberry+plants" },
    ],
    varieties: [
      { name: "Cambridge Favourite", note: "Reliable mid-season. Sweet, classic flavour. Good for beginners" },
      { name: "Elsanta", note: "Heavy cropper, firm fruit, the supermarket standard but better fresh" },
      { name: "Malling Centenary", note: "Large berries, excellent flavour, bred in the UK" },
      { name: "Flamenco", note: "Everbearing — fruits June to October. Perfect for extending the season" },
    ],
  },
  {
    name: "Raspberries",
    ...
    plantOutWeeks: -6,
    harvestWeeks: 52,
    tip: "Plant bare-root canes in winter for the cheapest option. Summer varieties fruit on last year's canes, autumn varieties on this year's — the pruning is completely different. Once established, a row of raspberries will produce for 10+ years.",
    ...
    avoidPlants: ["Tomatoes", "Peppers", "Aubergine"],
    minSoilTempC: 5,
    seedSuppliers: [
      { name: "Thompson & Morgan", url: "https://www.thompson-morgan.com/search?q=raspberry+canes" },
      { name: "Sarah Raven", url: "https://www.sarahraven.com/search?q=raspberry+plants" },
      { name: "Suttons", url: "https://www.suttons.co.uk/search?q=raspberry+canes" },
    ],
    varieties: [
      { name: "Glen Ample", note: "Summer. Spine-free canes, heavy cropper, excellent flavour" },
      { name: "Autumn Bliss", note: "Autumn. Fruits Aug–Oct on new canes. Easy to prune — just cut everything down in February" },
      { name: "Polka", note: "Autumn. Large berries, good disease resistance, fruits until first frost" },
      { name: "Tulameen", note: "Summer. Best flavour of all. Long fruiting season. The one restaurants use" },
    ],
  },
  {
    name: "Blackberries",
    ...
    plantOutWeeks: -6,
    harvestWeeks: 52,
    tip: "Cultivated blackberries produce bigger, sweeter fruit than wild ones and are thornless. Train along wires or a fence. They fruit on last year's growth, so tie in new canes as they grow and cut out the fruited ones after harvest.",
    ...
    minSoilTempC: 5,
    seedSuppliers: [
      { name: "Thompson & Morgan", url: "https://www.thompson-morgan.com/search?q=blackberry+plants" },
      { name: "Sarah Raven", url: "https://www.sarahraven.com/search?q=blackberry" },
      { name: "Suttons", url: "https://www.suttons.co.uk/search?q=blackberry+plants" },
    ],
    varieties: [
      { name: "Loch Ness", note: "Thornless, compact, heavy cropping. The best all-rounder" },
      { name: "Apache", note: "Thornless, large sweet berries, upright growth" },
      { name: "Karaka Black", note: "Huge, long berries with exceptional flavour. Early cropping" },
    ],
  },
  {
    name: "Gooseberries",
    ...
    plantOutWeeks: -8,
    harvestWeeks: 52,
    tip: "One of the easiest fruit bushes for UK allotments. Plant a bare-root bush in winter, prune to an open goblet shape, and it will produce kilos of fruit every summer for 20+ years. Pick them young for cooking, or leave to ripen fully for eating fresh.",
    ...
    minSoilTempC: 5,
    seedSuppliers: [
      { name: "Thompson & Morgan", url: "https://www.thompson-morgan.com/search?q=gooseberry+bush" },
      { name: "Sarah Raven", url: "https://www.sarahraven.com/search?q=gooseberry" },
      { name: "Suttons", url: "https://www.suttons.co.uk/search?q=gooseberry" },
    ],
    varieties: [
      { name: "Invicta", note: "Green, heavy cropper, mildew resistant. The most reliable" },
      { name: "Hinnonmaki Red", note: "Red dessert variety, sweet enough to eat raw. Compact" },
      { name: "Leveller", note: "Large yellow-green berries, superb flavour. Needs good soil" },
    ],
  },
  {
    name: "Blackcurrants",
    ...
    plantOutWeeks: -8,
    harvestWeeks: 52,
    tip: "Blackcurrants are packed with vitamin C and make the best jam and cordial. Plant deep — 5cm below the soil line — to encourage strong shoots from the base. Prune a third of the oldest wood out each winter. One bush produces 4-5kg of fruit.",
    ...
    spacingCm: 150,
    companionPlants: ["Garlic"],
    avoidPlants: [],
    minSoilTempC: 5,
    seedSuppliers: [
      { name: "Thompson & Morgan", url: "https://www.thompson-morgan.com/search?q=blackcurrant+bush" },
      { name: "Sarah Raven", url: "https://www.sarahraven.com/search?q=blackcurrant" },
      { name: "Suttons", url: "https://www.suttons.co.uk/search?q=blackcurrant" },
    ],
    varieties: [
      { name: "Ben Sarek", note: "Compact, heavy cropping, good disease resistance. Best for small spaces" },
      { name: "Big Ben", note: "Huge berries, sweet enough to eat fresh. Vigorous grower" },
      { name: "Ben Connan", note: "Early cropping, large fruit, manageable size. Award winner" },
    ],
  },
  {
    name: "Redcurrants",
    ...
    plantOutWeeks: -8,
    harvestWeeks: 52,
    tip: "Beautiful jewel-like berries that hang in trusses. They tolerate more shade than most fruit, so they are perfect for a north-facing fence. Prune to a permanent framework like a gooseberry, not like a blackcurrant.",
    ...
    minSoilTempC: 5,
    seedSuppliers: [
      { name: "Thompson & Morgan", url: "https://www.thompson-morgan.com/search?q=redcurrant+bush" },
      { name: "Suttons", url: "https://www.suttons.co.uk/search?q=redcurrant" },
    ],
    varieties: [
      { name: "Jonkheer van Tets", note: "Early, heavy cropping, good flavour. The standard variety" },
      { name: "Rovada", note: "Late season, very long trusses, excellent for jelly" },
      { name: "Red Lake", note: "Mid-season, reliable, slightly sweeter than most" },
    ],
  },
  {
    name: "Rhubarb",
    ...
    plantOutWeeks: -8,
    harvestWeeks: 52,
    tip: "Plant a crown in winter, do not harvest the first year, and it will reward you with decades of stalks. Pull (do not cut) stalks from April to June, then leave it alone to build strength for next year. Force a clump in January for the most tender, pink stems.",
    ...
    spacingCm: 90,
    companionPlants: ["Broad beans"],
    avoidPlants: [],
    minSoilTempC: 5,
    seedSuppliers: [
      { name: "Thompson & Morgan", url: "https://www.thompson-morgan.com/search?q=rhubarb+crowns" },
      { name: "Sarah Raven", url: "https://www.sarahraven.com/search?q=rhubarb" },
      { name: "Suttons", url: "https://www.suttons.co.uk/search?q=rhubarb+crowns" },
    ],
    varieties: [
      { name: "Timperley Early", note: "Earliest to crop, ready from March. Thin stalks, good forced" },
      { name: "Victoria", note: "The classic. Thick stalks, reliable, excellent for pies and crumbles" },
      { name: "Champagne", note: "Beautiful pink stems, sweeter than most, forces brilliantly" },
    ],
  },
];
